...
impl EnvSettings {
    pub fn new() -> Self {
        Self {
            db_collection_path: env::var("DB_COLLECTION_FILE_PATH").expect("DB_COLLECTION_FILE_PATH in .env file is missing"),
            ...
            user_jwt_secret: env::var("USER_JWT_SECRET").expect("USER_JWT_SECRET in .env file is missing"),
        }
    }
}
